    ...
    <View>
      <GooglePlacesAutocomplete
        ...
        onPress={(data, details = null) => {
          console.log(data,'THIS IS MT DATA')
          console.log(details,'THIS IS MT DETAILS')
          if (type == 'Home1') {
            navigation.navigate(navigationStrings.HOME, {
              details,
            });
            ...
            //   addressType,
            // });
            updateTheAddress(details, addressType,data);
          } else if (type == 'addAddress') {
            console.log(type, 'type-addAddress');
            let addressData = getAddressComponent(details,data);
            addressHelper(addressData);
          } else if (type == 'updateAddress') {
            let update = 'update';
            let addressData = getAddressComponent(details,data,update);
            addressHelper(addressData);
          }
        }}
        query={{
