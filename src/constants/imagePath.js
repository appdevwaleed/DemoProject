...
export default {
  ...
  google: require('../assets/images/ic_google2.png'),
  ...
  backIconWhite: require('../assets/images/arrow-forward-outline.png'),
  ...
  messageDark: require('../assets/images/ic_masglight.png'),
  ...
  callDark: require('../assets/images/ic_calllight.png'),
  ...
  eyeOpened: require('../assets/images/ic-eyeopened.png'),
  eyeClosed: require('../assets/images/ic-eyeclosed.png'),
  clockIcon: require('../assets/images/icons8-clock-24.png'),
  addressIcon: require('../assets/images/location-outline.png'),
  downArrow: require('../assets/images/down_arrow.png'),
  upArrow: require('../assets/images/up_arrow.png'),
  vehicleIcon: require('../assets/images/mask_group.png'),
  callIcon: require('../assets/images/call.png'),
  distanceIcon: require('../assets/images/distance.png'),
  feeIcon: require('../assets/images/fee.png'),
  boxIcon: require('../assets/images/box.png'),
  searchBlack:require('../assets/images/searchBlack.png'),
  forwardBlack:require('../assets/images/forwardBlack.png'),
  searchRed:require('../assets/images/searchRed.png'),

  areaBlack:require('../assets/images/areaBlack.png'),
  areaWhite:require('../assets/images/areaWhite.png'),
  timeOutlineWhite:require('../assets/images/timeOutlineWhite.png'),
  timeOutlineBlack:require('../assets/images/timeOutlineBlack.png'),
  beggage:require('../assets/images/beggage.png'),
  timer:require('../assets/images/timer.png'),
  cubeBlueIcon:require('../assets/images/cubeBlueIcon.png'),
  bucketBlueIcon:require('../assets/images/bucketBlueIcon.png'),
  clockBlueIcon:require('../assets/images/clockBlueIcon.png'),

  cardBlue:require('../assets/images/cardBlue.png'),
  arrowUpBlueBack:require('../assets/images/arrowUpBlueBack.png'),
  summeryIcon:require('../assets/images/summeryIcon.png'),
  locationIconBlue:require('../assets/images/locationIconBlue.png'),
  arrowDownBlueBack:require('../assets/images/arrowDownBlueBack.png'),
  personContact:require('../assets/images/personContact.png'),
  // arrowDownBlueBack:require('../assets/images/arrowDownBlueBack.png'),
  whatsappicon:require('../assets/images/whatsappicon.png'),
  callIconBlue:require('../assets/images/callIconBlue.png'),
  truckiconBlue:require('../assets/images/truckiconBlue.png'),
