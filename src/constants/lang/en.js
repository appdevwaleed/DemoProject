export default {
  ...
  DELIEVERY_ADDRESS: 'Delivery Details',
  PAYMENT: 'Payment',
  ...
  APPLYSMALL: 'Apply',
  AREYOUSURE: 'Are you sure you want to clear your basket?',
  ...
  PRODUCT_ADDED_SUCCESS: 'Product successfully added in your Basket',
  LOADING: 'Loading',
  ACCEPTED: 'Accepted',
  ...
  OTP: 'otp',
  PASSWORD: 'password',
  PASSWORD_REQUIRE_EIGHT_CHARACTRES: 'Password requires minimum 8 characters',
  INVALID_PASSWORD: 'Password is incorrect',
  NEW_PASSWORD: 'New password',
  NEW_PASSWORD_REQUIRE_EIGHT_CHARACTRES:
...
Amount`,
  ...
  YOUR_CART_EMPTY_ADD_ITEMS: 'Your Basket is empty, add items to shop',
  SHOP_FROM_WISHLIST: 'Shop from wishlist',
  ALREADY_EXIST:
    'You already have items in your cart from another seller. Do you want to discard them?',
  LABEL1: 'Label 1',
  LABEL2: 'Label 2',
  ...
  FROM: 'From',
  REMOVE_PROFILE_PHOTO: 'Remove Photo',
  SIGNUP_NEW_USER: 'SignUp (New User)',
  SIGNIN_EXISTING_USER: 'SignIn (Existing User)',
  SKIP: 'Skip',
  ...
  WALLET: 'Wallet',
  CARD: 'Card',
  CHOOSE_YOUR_REFUND_MODE: 'Choose your refund mode',
  COD_AMOUNT_EXCEED: 'The order can not be done using Cash on Delivery. Maximum allowable amount for an order exceeded',
  ORDER_RECEIPT: 'Order receipt',
  DEDUCT_FROM_WALLET: 'Deduct from wallet',
  DELIVERED_TO: 'Delivered To',
  NO_DELIVERY: ' Sorry, we don’t deliver to this location',
  MAKE_PAYMENT: 'PROCEED TO PAYMENT',
  PRODUCT_AMOUNT: 'Product Amount',
  ADDRESS_NOT_ADDED: 'The delivery address need to be added in order to make new order',
  BASKET: 'Basket',
  CLEAR_BASKET: 'Clear Basket',
  DOWNLOAD_RECEIPT: 'Download Receipt',
  SHARE: 'Share',
  REFERAL_EMAIL: 'Referral Email',
  YOUR_ORDER_WILL_EXPECTED_TO_ARRIVE_BY: 'Your order expected to deliver by',
  CONFIRM_SHIPMENT: 'CONFIRM SHIPMENT',
  PICKUP_LOCATION: 'Pick up Location',
  PICKUP: 'Pick up',
  DROPOFF_LOCATION: 'Drop Location',
  DROPOFF: 'Drop off',
  SCHEDULED_DATETIME:'Scheduled For',
  NO_DELIVERY_SERVICE_AVAILABLE: "Sorry we don't provide service in this area",

  ADDRESS_UNSELECTED_ERROR:"Please select address from drop down",
  DIMENSIONS:"Dimensions",
  SLA:"SLA",
  NO_OPTION_SELECTED:"Confirm Shipment",
  ORDER_SUMMARY:"Order Summary",
  SHIPMENT_DETAILS:"Vendor & Shipment details",
  ...
  SAMEPICKUPDROPCHECK:"Same as pickup ?",
