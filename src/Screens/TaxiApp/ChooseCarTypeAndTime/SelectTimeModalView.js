...
export default function SelectTimeModalView({
  ...
  console.log("TaxiApp - SelectTimeModalView.js")
    ...
    <View
      ...
      <View
        ...
        //  date={Platform.OS === 'android' ? (date ? date : new Date()) : null}
          date={Platform.OS === 'android' ? (date ? date : new Date()) : (date ? date : new Date())}
          mode="time"
          locale='en'
  ...
  return (
    <View
      ...
      <ModalView
        ...
        mainViewStyle={styles.mainViewStyleDate}
      ...
      <ModalView
        ...
        modalStyle={styles.modalContainer}
        mainViewStyle={styles.mainViewStyleTime}
